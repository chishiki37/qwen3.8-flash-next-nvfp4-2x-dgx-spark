...
OUT = "/home/vikassridhar/qwen_nvfp4kv_c1probe.jsonl"
...
RUNGS = [
    ("C1_64K", 1, 63000, 512),
    ("C1_128K", 1, 125000, 512),
    ("C1_250K", 1, 248000, 512),
]
def build_prompt(target_tokens):
    ...
    return ("Context study. Read the passage below once, then answer the question at the end.\n\n"
            + PARA * copies
            + "\n\nTask: Write a detailed essay of at least 400 words analyzing the passage's "
              "central argument about memory walls, how each hardware generation "
              "moves the bottleneck, and what the desk-scale analogy implies for "
              "inference clusters. Quote specific mechanisms from the passage.")
