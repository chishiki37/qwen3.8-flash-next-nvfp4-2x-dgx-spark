...
TRTLLM_GATE_ANCHOR = """        trtllm_decode = _resolve_trtllm_sparse_decode()
        if trtllm_decode is not None:
"""
TRTLLM_GATE_REPLACEMENT = """        trtllm_decode = _resolve_trtllm_sparse_decode()
        if trtllm_decode is not None and fp4_kv is None:  # dspark: FP4 pools use FA2/Triton path
"""
...
def main() -> None:
    patch(
        ...
        [
            ...
            (TRTLLM_GATE_ANCHOR, TRTLLM_GATE_REPLACEMENT),
